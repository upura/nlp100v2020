...
ja_text = '日本 の 水墨 画 を 一変 さ せ た 。'
en_text = ' '.join(['<sos>'] * len(ja_text.split()))
test_text = f'{en_text}\t{ja_text}'
with open('ch10/kftt-data-1.0/data/tok/tmp.txt', mode='w') as f:
    f.write(test_text)
...
print(decode_text(torch.transpose(y_preds[0], 0, 1)[0]))
